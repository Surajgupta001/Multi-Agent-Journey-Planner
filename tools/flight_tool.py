...
from config.constants import CITY_MAIN_AIRPORT, COUNTRY_ALIASES, COUNTRY_MAIN_AIRPORT
from utils.utils import clean_text, format_flight
...
# Change this if your default origin is not India/Delhi
...
# Get the main airport for a given country code
...
def airport_country_matches(airport: Mapping[str, Any], country_code: str) -> bool:
